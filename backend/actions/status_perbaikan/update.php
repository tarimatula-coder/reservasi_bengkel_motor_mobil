...
if (isset($_POST['tombol'])) {
    ...
    if ($id <= 0) {
        echo "<script>alert('ID Status perbaikan tidak valid!'); window.history.back();</script>";
        exit;
    }
...
";
    ...
    if (mysqli_query($connect, $q)) {
        echo "<script>alert('Berhasil update status perbaikan'); window.location.href='../../pages/status_perbaikan/index.php';</script>";
    } else {
