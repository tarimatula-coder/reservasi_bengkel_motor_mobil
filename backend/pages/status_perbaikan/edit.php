...
<div id="wrapper">
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-xl-12">
                    <h2 class="pageheader-title">Edit Data Status perbaikan</h2>
                    <p class="pageheader-text">Perbarui informasi status perbaikan sesuai kebutuhan.</p>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0">Form Edit Reservasi</h4>
                        </div>

                        <div class="card-body">
                            <form action="../../actions/status_perbaikan/update.php" method="POST">
