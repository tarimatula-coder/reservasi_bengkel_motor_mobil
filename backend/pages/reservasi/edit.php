...
<div id="wrapper">
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-xl-12">
                    <h2 class="pageheader-title">Edit Data Reservasi</h2>
                    <p class="pageheader-text">Perbarui informasi reservasi pelanggan sesuai kebutuhan.</p>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <form action="../../actions/reservasi/update.php" method="POST">
