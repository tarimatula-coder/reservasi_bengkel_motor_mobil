            ...
            <div class="row mb-4">
                <div class="col-xl-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Tambah Data Servis perbaikan</h2>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0">Form Tambah Jadwal servis perbaikan</h4>
                        </div>

                        <div class="card-body">
                            <form action="../../actions/jadwal_servis/store.php" method="POST">
